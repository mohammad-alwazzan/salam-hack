...
import { SendHorizontal, Loader, MessageSquare } from "lucide-react";
...
function ChatTranscript({ messages, isLoading }: ChatTranscriptProps) {
    ...
    >
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-semibold tracking-tight">Salam Agent</h1>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 pt-6 pb-2 shrink-0">
        <div>
          <h1 className="text-lg font-semibold tracking-tight">Salam Agent</h1>
