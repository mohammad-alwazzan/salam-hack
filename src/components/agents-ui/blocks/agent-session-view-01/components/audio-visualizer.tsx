...
import { AgentAudioVisualizerAura } from 'frontend/components/agents-ui/agent-audio-visualizer-aura';
import { AgentAudioVisualizerBar } from 'frontend/components/agents-ui/agent-audio-visualizer-bar';
import { AgentAudioVisualizerGrid } from 'frontend/components/agents-ui/agent-audio-visualizer-grid';
import { AgentAudioVisualizerRadial } from 'frontend/components/agents-ui/agent-audio-visualizer-radial';
import { AgentAudioVisualizerWave } from 'frontend/components/agents-ui/agent-audio-visualizer-wave';
